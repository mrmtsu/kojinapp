$(function() {
  // 子カテゴリーを追加するための処理です。
    function buildChildHTML(child){
      var html =`<a class="children_category" id="${child.id}" 
  ...
  $(document).on("mouseover", ".children_category", function () {//子カテゴリーのリストは動的に追加されたHTMLのため
    var id = this.id
    ...
    $.ajax({
      ...
      $(document).on("mouseover", ".children_category", function () {
